//This code processes the wifi log files and converts it to a wifi image
...
class Row
{
  ...
  {
    numRow++;
    String linesAVG[] = loadStrings("C:\\Users\\Desktop\\SampleLogs\\log" + index + ".txt"); //dbm of each pixel for the new one + ADD INDEX!!!!!
